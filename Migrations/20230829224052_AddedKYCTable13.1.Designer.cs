...
namespace tradingAppCS.Migrations
{
    ...
    [Migration("20230829224052_AddedKYCTable13.1")]
    partial class AddedKYCTable131
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("tradingAppCS.Models.kycTable", b =>
                {
                    ...
                    b.ToTable("kycTable", (string)null);
                });
            ...
            modelBuilder.Entity("tradingAppCS.Models.kycTable", b =>
                {
                    b.HasOne("tradingAppCS.Models.User", null)
                        .WithOne("KYC")
                        .HasForeignKey("tradingAppCS.Models.kycTable", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
